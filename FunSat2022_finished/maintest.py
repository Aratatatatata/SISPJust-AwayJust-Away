...
#インスタンスの作成
    ...
    filename = '/home/funsat/Desktop/FanSat2022.10.26/testtestdata'
    for i in range(100):
...
#GPSkakunin
    ...
    while True:
        ...
        with open(filename_str,'a',newline="") as f:
            ...
            with open(filename_str,'a',newline="") as f:
                writer = csv.writer(f)
                writer.writerow(['fall_junnbi',gps.gps.timestamp[0],gps.gps.timestamp[1],gps.gps.timestamp[2],'latitude',gps.gps.latitude[0],'longitude',gps.gps.longitude[0]])
