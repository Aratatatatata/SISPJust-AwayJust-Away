...
#落下検知
    while True:
        ...
        with open(filename,'a',newline="") as f:
            ...
            writer.writerow(['fall',gps.gps.timestamp[0],gps.gps.timestamp[1],gps.gps.timestamp[2],gps.gps.latitude[0],gps.gps.longitude[0],acc[0],acc[1],acc[2],0,0])
...
#制御開始
    ...
    with open(filename,'a',newline="") as f:
            writer = csv.writer(f)
            writer.writerow([gps.gps.timestamp[0],gps.gps.timestamp[1],gps.gps.timestamp[2],gps.gps.latitude[0],gps.gps.longitude[0],acc[0],acc[1],acc[2],0,0])
    ...
    while True:
        ...
        with open(filename,'a',newline="") as f:
            writer = csv.writer(f)
            writer.writerow(['control',gps.gps.timestamp[0],gps.gps.timestamp[1],gps.gps.timestamp[2],gps.gps.latitude[0],gps.gps.longitude[0],let])
